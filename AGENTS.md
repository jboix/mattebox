...
> The design record (`docs/specs/`) is maintained locally by the project owner and is
...
Also update the debt register design doc (16): add anything you deferred, stubbed, or configured temporarily, and remove entries your stage resolved.
