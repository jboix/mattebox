...
At any given time we support the _latest_ version of Mattebox (as reflected in
the _main_ branch) with security updates.
...
[report a vulnerability](https://github.com/jboix/mattebox/security/advisories/new)
...
Before reporting, make sure you are on the latest version of Mattebox and a
supported Node version (20.19 or later).
